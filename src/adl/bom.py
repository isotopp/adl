...
class Config:
    ...
    def ready(self):
        return (
            self.activation_certificate is not None
            and self.authentication_certificate is not None
        )
...
class Account:
    ...
    def __str__(self):
        ...
        auth_cert = "Authentication certificate: {}".format(
    ...
    def get_private_key(self):
        ...
        pk = utils.aes_decrypt(
            base64.b64decode(self.encryptedPK), base64.b64decode(d.device_key)
        )
        return pk
