from context import utils, device, api_call, bom, data
...
class TestDevice(unittest.TestCase):
    ...
    def test_write_activation_file(self):
        ...
        m.assert_called_once_with(
            "./fake_device/.adobe-digital-editions/activation.xml", "w"
        )
        h = m()
    ...
    def test_activate_device(self):
        ...
        backup = (
            device.activate,
            data.add_device,
            default_account.get_private_key,
            device.read_device_file,
            device.read_activation_file,
            device.build_activation_file,
            device.write_activation_file,
        )
