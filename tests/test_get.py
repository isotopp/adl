...
class TestGet(unittest.TestCase):
    ...
    def test_login(self):
        ...
        backup = (
            ...
            utils.extract_pk_from_pkcs12,
            xml_tools.generate_signature,
            utils.make_nonce,
    ...
    def test_fulfillment(self):
        ...
        with patch("requests.post") as mock_request:
            ...
            self.assertEqual(
                etree.tostring(licenseToken),
                b'<licenseToken xmlns="http://ns.adobe.com/adept">toto</licenseToken>',
            )
